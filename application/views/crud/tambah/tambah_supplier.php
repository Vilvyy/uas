...
<html lang="en">
  ...
  <div class="container">
    <div class=>
      <a href="<?=base_url('index.php/menu/supplier')?>" class="btn btn-lg btn-primary btn-md">Back</a>
    </div>

<form action="<?=base_url('index.php/tambah/aksi_tambah_supplier')?>" method="post">
  <div class="row">
    <div class="col-md-6">
        <div class="row">
          <div class="col-md-6">
        ...
        <div class="row">
          <div class="col-md-6">
            <h3>Nomor Telepon</h3>
            <input type="number" name="telepon_supplier" class="form-control" required>
          </div>
        </div>
        <div class="row">
          <div class="col-md-6">
