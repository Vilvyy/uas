...
<html lang="en">
  ...
  <div class="container">
    <div class=>
      <a href="<?=base_url('index.php/menu/pengguna')?>" class="btn btn-lg btn-primary btn-md">Back</a>
    </div>

<form action="<?=base_url('index.php/edit/aksi_edit_user')?>" method="post">
<input type="hidden" name="id_user" value="<?=$id_user?>"class="form-control" required>
  <div class="row">
    <div class="col-md-6">
        <div class="row">
          <div class="col-md-6">
