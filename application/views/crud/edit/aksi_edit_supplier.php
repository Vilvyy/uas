...
<form action="<?=base_url('index.php/edit/aksi_edit_supplier')?>" method="post">
  <input type="hidden" name="id_supplier" class="form-control" value="<?=$id_supplier?> required">
  <div class="row">
    <div class="col-md-6">
        <div class="row">
          <div class="col-md-6">
            <h3>Nama Barang</h3>
            <input type="text" name="nama_supplier" class="form-control" value="<?=$nama_supplier?>" required>
          </div>
        </div>
        <div class="row">
          <div class="col-md-6">
