...
<html lang="en">
  ...
  <div class="container">
    <div>
      <a href="<?=base_url('index.php/menu/index')?>" class="btn btn-lg btn-primary">Back</a>
    </div>



<form action="<?=base_url('index.php/edit/aksi_edit_barang')?>" method="post">
<input type="hidden" name="kode_brg" value="<?=$kode_brg?>" class="form-control" required>	
  <div class="row">
    <div class="col-md-6">
        <div class="row">
          <div class="col-md-6">
        ...
        <div class="row">
          <div class="col-md-6">
            <h3>Jenis Barang</h3>
            <input type="text" name="jenis_barang" value="<?=$jenis_barang?>" class="form-control" required>
          </div>
        </div>
        <div class="row">
          <div class="col-md-6">
            <h3>Jumlah</h3>
            <input type="number" name="stok_barang" value="<?=$stok_barang?>" class="form-control" required>
          </div>
        </div>
        <div class="row">
          <div class="col-md-6">
